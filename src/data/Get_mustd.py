...
def getmustd(traintf, train_position,reference,target,refidx = 1):
    """
...
traintf = "db/split_2/train_4000.tfrecord"
train_position = "positions"
reference ="atomrefs.txt.npz"
outfile = open("db/split_2/reference_4000.csv","w")
for t in range(3,15):
    if t == 9:
        refidx = 0
    elif t == 10:
        ...
        refidx = False
    mu,std = getmustd(traintf, train_position,reference, t, refidx)
